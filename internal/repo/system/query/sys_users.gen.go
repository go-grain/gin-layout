...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.Introduction = field.NewString(tableName, "introduction")
	_sysUser.PersonalWebsite = field.NewString(tableName, "personal_website")
	_sysUser.Certification = field.NewInt(tableName, "certification")
	_sysUser.Roles = field.NewField(tableName, "roles")
	_sysUser.Role = field.NewString(tableName, "role")
	_sysUser.Status = field.NewString(tableName, "status")
	_sysUser.Organize = field.NewString(tableName, "organize")
	_sysUser.Department = field.NewString(tableName, "department")
	_sysUser.Position = field.NewString(tableName, "position")
...
type sysUser struct {
	...
	PersonalWebsite field.String
	Certification   field.Int
	Roles           field.Field
	Role            field.String
	Status          field.String
	Organize        field.String
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.PersonalWebsite = field.NewString(table, "personal_website")
	s.Certification = field.NewInt(table, "certification")
	s.Roles = field.NewField(table, "roles")
	s.Role = field.NewString(table, "role")
	s.Status = field.NewString(table, "status")
	s.Organize = field.NewString(table, "organize")
...
func (s *sysUser) fillFieldMap() {
	...
	s.fieldMap["personal_website"] = s.PersonalWebsite
	s.fieldMap["certification"] = s.Certification
	s.fieldMap["roles"] = s.Roles
	s.fieldMap["role"] = s.Role
	s.fieldMap["status"] = s.Status
	s.fieldMap["organize"] = s.Organize
